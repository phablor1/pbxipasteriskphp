    ...
    <table  class=" container table  table-hover  table-borderless " id="dataTable">
        <thead>
            <tr class="ramais_head" >
                ...
                <th>Deleter regra de discagem</th>  
                <!-- <th>Deletar</th>   -->
            </tr>
        </thead>
        <tbody>
        ...
        ?>
            <tr class="b-0">
                ...
                <a href="deleteDiscagem.php?id_discagem=<?php echo $id;?>&exten=<?php echo $exten;?>" class="btn btn-sucess btn-lg btn-block">
                    <i class="fas fa-trash-alt"></i>&nbsp;&nbsp;Deletar Discagem</a>
                </div>
                </td>
            </tr>
        <?php
