...
$sql = "select username,name,email from users";
?>
<!DOCTYPE html>
<html lang="en">

<head>
    <title>ConectX - Usuarios</title>
    <meta charset="utf-8">
                                    ...
                                    <table class="table table-actions table-striped table-hover mb-0">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="formEditUsuario.php?user=<?php echo $usuario ?>"><button class="btn btn-sm btn-primary">Editar</button></a>
                                                    <a href="deleteUsuario.php?user=<?php echo $usuario ?>"><button class="btn btn-sm btn-danger">Exclui</button></a>
                                                </td>
                                            </tr>
                                            <!--<tr>
                                                <th scope="row">
